...
pub mod BalancerV2ComposableStablePoolFactoryV6 {
    ...
    ///Container for all the [`BalancerV2ComposableStablePoolFactoryV6`](self)
    /// function calls.
    #[derive(Clone)]
            ...
            >] = &[
                {
                    fn disable(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BalancerV2ComposableStablePoolFactoryV6Calls>
                    {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BalancerV2ComposableStablePoolFactoryV6Events {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BalancerV2ComposableStablePoolFactoryV6Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BalancerV2ComposableStablePoolFactoryV6Instance<P, N> {
        #[inline]
    ...
    impl<P: ::core::clone::Clone, N> BalancerV2ComposableStablePoolFactoryV6Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned
        /// provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BalancerV2ComposableStablePoolFactoryV6Instance<P, N> {
...
pub type Instance =
    BalancerV2ComposableStablePoolFactoryV6::BalancerV2ComposableStablePoolFactoryV6Instance<
...
pub const fn deployment_info(chain_id: u64) -> Option<(Address, Option<u64>)> {
    match chain_id {
        ...
        8453u64 => Some((
            ::alloy_primitives::address!("0x956CCab09898C0AF2aCa5e6C228c3aD4E93d9288"),
            Some(11099703u64),
        )),
        42161u64 => Some((
            ::alloy_primitives::address!("0x4bdCc2fb18AEb9e2d281b0278D946445070EAda7"),

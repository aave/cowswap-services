...
pub mod BalancerV2ComposableStablePoolFactory {
    ...
    ///Container for all the [`BalancerV2ComposableStablePoolFactory`](self)
    /// function calls.
    #[derive(Clone)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BalancerV2ComposableStablePoolFactoryEvents {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BalancerV2ComposableStablePoolFactoryEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BalancerV2ComposableStablePoolFactoryInstance<P, N> {
        #[inline]
    ...
    impl<P: ::core::clone::Clone, N> BalancerV2ComposableStablePoolFactoryInstance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned
        /// provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BalancerV2ComposableStablePoolFactoryInstance<P, N> {
...
pub type Instance =
    BalancerV2ComposableStablePoolFactory::BalancerV2ComposableStablePoolFactoryInstance<

...
pub mod BalancerV2ComposableStablePoolFactoryV5 {
    ...
    ///Container for all the [`BalancerV2ComposableStablePoolFactoryV5`](self)
    /// function calls.
    #[derive(Clone)]
            ...
            >] = &[
                {
                    fn disable(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BalancerV2ComposableStablePoolFactoryV5Calls>
                    {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BalancerV2ComposableStablePoolFactoryV5Events {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BalancerV2ComposableStablePoolFactoryV5Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BalancerV2ComposableStablePoolFactoryV5Instance<P, N> {
        #[inline]
    ...
    impl<P: ::core::clone::Clone, N> BalancerV2ComposableStablePoolFactoryV5Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned
        /// provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BalancerV2ComposableStablePoolFactoryV5Instance<P, N> {
...
pub type Instance =
    BalancerV2ComposableStablePoolFactoryV5::BalancerV2ComposableStablePoolFactoryV5Instance<

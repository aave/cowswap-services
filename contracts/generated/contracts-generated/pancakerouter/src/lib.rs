...
pub mod PancakeRouter {
    ...
    impl alloy_sol_types::SolInterface for PancakeRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<PancakeRouterCalls>] = &[
                {
                ...
                {
                    fn quote(data: &[u8]) -> alloy_sol_types::Result<PancakeRouterCalls> {
                ...
                {
                    fn factory(data: &[u8]) -> alloy_sol_types::Result<PancakeRouterCalls> {
                ...
                {
                    fn addLiquidity(data: &[u8]) -> alloy_sol_types::Result<PancakeRouterCalls> {
    ...
    impl<P, N> ::core::fmt::Debug for PancakeRouterInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("PancakeRouterInstance")
                .field(&self.address)
                .finish()
        }
    }

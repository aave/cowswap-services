...
pub mod BalancerV2WeightedPoolFactoryV3 {
    ...
    ///Container for all the [`BalancerV2WeightedPoolFactoryV3`](self) function
    /// calls.
    #[derive(Clone)]
    ...
    impl alloy_sol_types::SolInterface for BalancerV2WeightedPoolFactoryV3Calls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(
                ...
                BalancerV2WeightedPoolFactoryV3Calls,
            >] = &[
                {
                    fn disable(
                        data: &[u8],
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BalancerV2WeightedPoolFactoryV3Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    #[derive(Clone)]
    pub struct BalancerV2WeightedPoolFactoryV3Instance<P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
    ...
    impl<P: ::core::clone::Clone, N> BalancerV2WeightedPoolFactoryV3Instance<&P, N> {
        ...
        /// provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BalancerV2WeightedPoolFactoryV3Instance<P, N> {

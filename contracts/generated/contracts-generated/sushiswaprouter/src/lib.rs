...
pub mod SushiSwapRouter {
    ...
    impl alloy_sol_types::SolInterface for SushiSwapRouterCalls {
        ...
        fn abi_decode_raw(selector: [u8; 4], data: &[u8]) -> alloy_sol_types::Result<Self> {
            static DECODE_SHIMS: &[fn(&[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls>] = &[
                {
                ...
                {
                    fn WETH(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn quote(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn factory(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
                ...
                {
                    fn addLiquidity(data: &[u8]) -> alloy_sol_types::Result<SushiSwapRouterCalls> {
    ...
    impl<P, N> ::core::fmt::Debug for SushiSwapRouterInstance<P, N> {
        ...
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("SushiSwapRouterInstance")
                .field(&self.address)
                .finish()
        }
    }
...
pub type Instance = SushiSwapRouter::SushiSwapRouterInstance<::alloy_provider::DynProvider>;
use {

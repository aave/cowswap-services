...
pub mod BalancerV2ComposableStablePoolFactoryV3 {
    ...
    ///Container for all the [`BalancerV2ComposableStablePoolFactoryV3`](self)
    /// function calls.
    #[derive(Clone)]
            ...
            >] = &[
                {
                    fn disable(
                        data: &[u8],
                    ) -> alloy_sol_types::Result<BalancerV2ComposableStablePoolFactoryV3Calls>
                    {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for BalancerV2ComposableStablePoolFactoryV3Events {
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for BalancerV2ComposableStablePoolFactoryV3Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    #[automatically_derived]
    impl<P, N> ::core::fmt::Debug for BalancerV2ComposableStablePoolFactoryV3Instance<P, N> {
        #[inline]
    ...
    impl<P: ::core::clone::Clone, N> BalancerV2ComposableStablePoolFactoryV3Instance<&P, N> {
        /// Clones the provider and returns a new instance with the cloned
        /// provider.
        #[inline]
        pub fn with_cloned_provider(self) -> BalancerV2ComposableStablePoolFactoryV3Instance<P, N> {
...
pub type Instance =
    BalancerV2ComposableStablePoolFactoryV3::BalancerV2ComposableStablePoolFactoryV3Instance<

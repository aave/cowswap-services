    ...
    impl alloy_sol_types::SolInterface for LiquoriceSettlementCalls {
        ...
        fn abi_encoded_size(&self) -> usize {
            match self {
                ...
                Self::BALANCE_MANAGER(inner) => {
                    <BALANCE_MANAGERCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                Self::DOMAIN_SEPARATOR(inner) => {
                    <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                Self::hashSingleOrder(inner) => {
                    <hashSingleOrderCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
                ...
                Self::settleSingle(inner) => {
                    <settleSingleCall as alloy_sol_types::SolCall>::abi_encoded_size(inner)
                }
            }
        }
        ...
        fn abi_encode_raw(&self, out: &mut alloy_sol_types::private::Vec<u8>) {
            match self {
                ...
                Self::BALANCE_MANAGER(inner) => {
                    <BALANCE_MANAGERCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::DOMAIN_SEPARATOR(inner) => {
                    <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::hashSingleOrder(inner) => {
                    <hashSingleOrderCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
                Self::isValidSignature(inner) => {
                ...
                Self::settleSingle(inner) => {
                    <settleSingleCall as alloy_sol_types::SolCall>::abi_encode_raw(inner, out)
                }
            }
        }
    }

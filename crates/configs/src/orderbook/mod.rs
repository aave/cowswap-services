...
pub struct Configuration {
    ...
    /// When enabled, skips the verification that deployed contract constants
    /// (domain separator) match the ones compiled into this binary. Useful
    /// when running on a fork with a different chain ID.
    #[serde(default)]
